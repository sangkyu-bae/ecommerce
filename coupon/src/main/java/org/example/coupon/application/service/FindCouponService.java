...
public class FindCouponService implements FindCouponUseCase {
    ...
    @Override
    public Coupon findCouponByCouponId(FindCouponCommand command) {
        CouponEntity couponEntity = findCouponPort.findCouponByCouponId(new Coupon.CouponId(command.getCouponId()));
